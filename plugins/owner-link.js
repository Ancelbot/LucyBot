...
🍧✞͙͙͙͙͙͙͙͙͙͙︶ִֶָ⏝⏝˖ ࣪ ୨𔘓୧ ࣪ ˖⏝ִֶָ⏝ִֶָ✞͙͙͙͙͙͙͙͙͙͙🍓`, contextInfo: { externalAdReply: { showAdAttribution: true, title: `𝅻ㄆ 𝕵𝖔𝖘𝖘 𝕭𝖔𝖙🏴‍☠️ ﹣ 𝖬𝖣`, body: wm3, sourceUrl: yt, thumbnail: imagen2 }, mentionedJid: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }}}, { quoted: fakegif })
